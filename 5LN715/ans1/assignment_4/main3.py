...
def measure_bubble_sort():
    ...
    for i, test_list in enumerate(test_lists):  # Loop through each test list
        ...
        bubble_sort_interative.bubble_sort_interative(test_list.copy())  # Sort the list using bubble sort
...
def write_to_csv(results, output_file='bubble_sort_times2.csv'):
    """
...
if __name__ == "__main__":
    results = measure_bubble_sort()  # Measure the bubble sort times
