...
def main():
    ...
    test_path = r'D:\J\Desktop\language technology\course\ans2 copy\combined_sentences.txt'  # 测试句子路径
    ...
    for sentence in test_sentences:
        ...
        sentence_results.append((sentence, avg_surprisal))
        print(f"句子: {sentence}")
        ...
        # 打印结果 print("\n句子结果:") 
        for sentence, avg_surprisal in sentence_results: 
            print(f"句子: {sentence}, 平均惊讶度: {avg_surprisal}") 
            print("\n单词结果:") 
        for word, duration, surprisal in word_results[:10]: 
