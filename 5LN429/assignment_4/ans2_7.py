...
def word_test(test_dict):
    ...
    while True:
        for english_word in english_words:
            ...
            user_answer = input(f"Please enter the Swedish translation for '{english_word}': ")
        ...
        # Prompt the user for "y" or "n" with a loop until a valid response is given
        while True:
            ...
            if retry == 'y':
                ...
                print("Please enter 'y' or 'n'.")  # Prompt again if input is invalid
