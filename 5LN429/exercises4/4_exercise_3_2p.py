...
def cal_readability(lines, word_freq):  # 第 42 行
    ...
    for line in lines:
        ...
        for word in words:
            ...
            complexity = cal_complexity(word, word_freq)  # 第 46 行
...
def main():
    ...
    readability = cal_readability(chomsky_lines, freq_dict)  # 第 50 行

    print("Finished!")
    print(f"Word frequency statistics for file '{en_file}':")
