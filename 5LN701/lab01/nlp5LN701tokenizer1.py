...
def main():
    ...
    #3.15 Precision = 0.9502762430939227 (860/905) Recall = 0.948180815876516 (860/907) F-score = 0.9492273730684326

    #pattern = "(?:\w+\.(?:\w+\.)*|\d+\.\d+|\w+(?:-\w+)*|\b\w+'t\b|[%#$“”.,:;!?‘’])"
    #3.16 Precision = 0.9249422632794457 (801/866) Recall = 0.8831312017640573 (801/907) F-score = 0.9035532994923857

    #pattern = "(?:\[A-Za-z]+\.(?:\[A-Za-z]]+\.)+|\d+\.\d+|\w+(?:-\w+)*|\b\w+'t\b|[%#$“”.,:;!?‘’])"
    #3.17 Precision = 0.9132762312633833 (853/934) Recall = 0.9404630650496141 (853/907) F-score = 0.926670287887018

    #pattern = "(\w+\.)+(?!$)/g|\d+\.\d+|\w+(?:-\w+)*|\b\w+'t\b|[%#$“”.,:;!?‘’])"
    #3.18 re.error: unbalanced parenthesis at position 61
